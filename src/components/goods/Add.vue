        ...
        >
          <el-tab-pane label="基本信息" name="0">
            ...
            <el-form-item label="商品价格" prop="goods_price">
              <el-input v-model="addForm.goods_price" type="number" placeholder></el-input>
            </el-form-item>
            <el-form-item label="商品重量" prop="goods_weight">
              <el-input v-model="addForm.goods_weight" type="number" placeholder></el-input>
            </el-form-item>
            <el-form-item label="商品数量" prop="goods_number">
              <el-input v-model="addForm.goods_number" type="number" placeholder></el-input>
            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleRemove(file) {
      ...
      //3.调用数组的splice方法，把图片信对象，从pics数组中移除
    ...
    add() {
      this.$refs.addFormRef.validate(async valid => {
        ...
        //执行添加的业务逻辑
        //lodash javascript原生库  cloneDeep(obj)
